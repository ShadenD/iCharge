...
<div class="dropdown7">
 ...
 <!-- _______________________________________________ -->
    ...
    <div style="background-image: url('images/background.jpg');background-repeat: no-repeat;height:400px;background-size: 110%;margin-top: 80px;width: 110%;">
        <br> <br> <br> <br> <br> 
        <center>
        <h1 style="color: white; font-size: 60px; font-weight: bold; margin-right: 120px; margin-top: 40px;">Contact Us</h1>
    <center> <div><p style="color: white; font-size: 21px;margin-right: 80px;" >Interested in our products or have any questions? Don't hesitate to reach out! Fill out<br> the form below and we'll be happy to assist.</p></div></center>
     </center>
    </div>
      <br>
      <br>
      <br>
      <div class="container">
      <div class="container12341">
        <h2>Steps for purchasing a sample charger:</h2>
        <ul class="steps12341">
            <li>Choose the charging station connector that fits your needs. This<br> could be AC station Type 1, Type 2 or GB/T, or DC station CCS1, CCS2,<br> Chademo, or GB/T.</li>
            <li>Identify your preferred output power for the charging station.<br> Options include 7KW, 11KW, 22KW, etc.</li>
            <li>Let us know if you're okay with our logo or prefer a white-label product.</li>
            <li>For AC charging stations, 100% upfront payment is required. We<br> accept payment via T/T or credit card. (Note: credit card payments<br> include a 7% transaction fee).</li>
            <li>We manufacture the sample and verify with you before we ship.</li>
        </ul>
        <div class="contact-info12341">
            <p><strong>Address:</strong><br>
            5th Floor, North Tower, Zhongdian Lighting Building, Nanshan District, Shenzhen, China</p>
            <p><strong>Tel:</strong> <a href="tel:+8618675578016">+86 186 7557 8016</a></p>
            <p><strong>Contact Sales:</strong> <a href="mailto:sales@electrly.com">sales@electrly.com</a></p>
            <p><strong>Contact Support:</strong> <a href="mailto:support@electrly.com">support@electrly.com</a></p>
        </div>
    </div>
